...
from .views import (
    ...
    OidcStatusView, OidcLoginView, OidcCallbackView,
...
urlpatterns = [
    ...
    path('oidc/status/',                        OidcStatusView.as_view(),               name='auth-oidc-status'),
    path('oidc/login/',                         OidcLoginView.as_view(),                name='auth-oidc-login'),
    path('oidc/callback/',                      OidcCallbackView.as_view(),             name='auth-oidc-callback'),
